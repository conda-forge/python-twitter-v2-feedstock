About python-twitter-v2-feedstock
=================================
...
<table><tr>
    <td>All platforms:</td>
    <td>
      <a href="https://github.com/conda-forge/python-twitter-v2-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/python-twitter-v2-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
pixi add python-twitter-v2
# for installing globally
pixi global install python-twitter-v2
```
...
It is possible to list all of the versions of `python-twitter-v2` available on your platform:
...
```
pixi search python-twitter-v2 --channel conda-forge
```
